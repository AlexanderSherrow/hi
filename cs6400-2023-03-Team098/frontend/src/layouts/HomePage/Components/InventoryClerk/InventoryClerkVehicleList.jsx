...
import { InventoryClerkVehicle } from "./InventoryClerkVehicle";
import '../Vehicle.css';

var constants = require('../../../../constants')

export function InventoryClerkVehicleList(props) {
  let [vehicleList, setVehicleList] = useState([]);
  const [isLoading, setIsLoading] = useState(false);
  const [firstSearch, setFirstSearch] = useState(false);

  useEffect(() => {
    let mainPath = "/vehicle/inventoryVehicleSearch";
  ...
  .then((result)=>{
    ...
    {
      vehicleList.push(
      <InventoryClerkVehicle key = {result[key].vin}
      vin = {result[key].vin}
